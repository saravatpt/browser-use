...
load_dotenv()
os.environ['GOOGLE_API_KEY'] = 'AIzaSyAdu_bOvDCTXV2TcFzHcx0bdmXyi2xozw0'
#api_key = os.getenv('GOOGLE_API_KEY')
#if not api_key:
#	raise ValueError('GOOGLE_API_KEY is not set')

llm = ChatGoogleGenerativeAI(model='gemini-2.0-flash', api_key="AIzaSyAdu_bOvDCTXV2TcFzHcx0bdmXyi2xozw0")
